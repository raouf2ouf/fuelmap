...
export class GalaxyFactory extends ContractFactory {

  static readonly bytecode = bytecode;

  constructor(accountOrProvider: Account | Provider) {
    super(bytecode, Galaxy.abi, accountOrProvider);
  }
  ...
  deploy<TContract extends Contract = Contract>(
    ...
    return super.deploy({
      storageSlots: Galaxy.storageSlots,
      ...deployOptions,
    });
  }
  ...
  ): Promise<DeployContractResult<Galaxy>> {
    const factory = new GalaxyFactory(wallet);
